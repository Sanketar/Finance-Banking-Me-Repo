node{
    ...
    stage('Git Code Checkout'){
        try{
            ...
            git 'https://github.com/Sanketar/Finance-Banking-Me-Repo.git'
        }
        catch(Exception e){
    ...
    stage('Containerize the Application'){
        ...
        sh "sudo ${dockerCMD} build -t sanketar/finance-me:${tagName} ."
    }
    ...
    stage('Pushing it to the DockerHub'){
        ...
        sh "sudo ${dockerCMD} push sanketar/finance-me:${tagName}"    
       }
    } 
